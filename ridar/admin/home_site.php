...
$no = 1;
      ...
      <button class ="btn btn-warning"><a href="home_site.php?hapus=<?=$a['site_id']; ?>" onclick="return confirm('Anda yakin akan menghapus site <?php echo $a['site_name']; ?> ?')"><i class="fa fa-trash"></i></a></button>
