...
$no = 1;
      ...
      <button class ="btn btn-warning"><a href="home_keg.php?hapus=<?=$a['id_keg']; ?>" onclick="return confirm('Anda yakin akan menghapus kegiatan <?php echo $a['id_keg']; ?> ?')"><i class="fa fa-trash"></i></a></button>
